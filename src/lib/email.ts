...
export async function sendGmailOtp(
  ...
  try {
    ...
    const htmlContent = `
      <div style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; max-width: 580px; margin: 0 auto; background-color: #FAF7F2; padding: 32px 24px; border-radius: 24px; border: 1px solid #EFEAE1;">
        <div style="text-align: center; margin-bottom: 24px;">
          <h1 style="color: #2D3E33; font-size: 26px; margin: 0; font-family: Georgia, serif;">Romi & Knot</h1>
        ...
        <div style="background-color: #FFFFFF; padding: 28px 24px; border-radius: 20px; border: 1px solid #EFEAE1; text-align: center;">
          ...
          <p style="color: #666666; font-size: 13px; margin-bottom: 24px;">Here is your 6-digit verification OTP code to complete your sign in on <strong>Romi & Knot</strong>:</p>
        ...
        <div style="text-align: center; margin-top: 24px; color: #999999; font-size: 11px;">
          <p style="margin-bottom: 4px;">© ${new Date().getFullYear()} Romi & Knot Studio. Handcrafted with love.</p>
    ...
    const info = await transporter.sendMail({
      from: `"Romi & Knot Handmade" <${gmailUser}>`,
      to: cleanEmail,
      subject: `✨ Your Romi & Knot Verification OTP Code: ${otpCode}`,
      html: htmlContent,
    });
